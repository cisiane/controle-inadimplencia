...
ORDER BY
	CASE
        WHEN Saldo_Investimento = 'Sem investimento' THEN 1
        WHEN Saldo_Investimento = 'Pouco' THEN 2
        WHEN Saldo_Investimento = 'Moderado' THEN 3
        WHEN Saldo_Investimento = 'Alto' THEN 4
    END;